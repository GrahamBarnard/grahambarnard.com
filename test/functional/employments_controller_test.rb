...
class EmploymentsControllerTest < ActionController::TestCase
  ...
  test "should create employment" do
    assert_difference('Employment.count') do
      post :create, employment: { description: @employment.description, finish_date: @employment.finish_date, position: @employment.position, start_date: @employment.start_date, website: @employment.website }
    end
  ...
  test "should update employment" do
    put :update, id: @employment, employment: { description: @employment.description, finish_date: @employment.finish_date, position: @employment.position, start_date: @employment.start_date, website: @employment.website }
    assert_redirected_to employment_path(assigns(:employment))
  end
