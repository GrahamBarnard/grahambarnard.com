...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { description: @education.description, finish_date: @education.finish_date, school: @education.school, start_date: @education.start_date }
    end
  ...
  test "should update education" do
    put :update, id: @education, education: { description: @education.description, finish_date: @education.finish_date, school: @education.school, start_date: @education.start_date }
    assert_redirected_to education_path(assigns(:education))
  end
