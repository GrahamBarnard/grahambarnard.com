...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { author: @testimonial.author, avatar: @testimonial.avatar, description: @testimonial.description, published: @testimonial.published }
    end
  ...
  test "should update testimonial" do
    put :update, id: @testimonial, testimonial: { author: @testimonial.author, avatar: @testimonial.avatar, description: @testimonial.description, published: @testimonial.published }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
